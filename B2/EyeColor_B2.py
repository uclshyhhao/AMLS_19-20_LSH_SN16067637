...
start = datetime.now()
cnn_training_B2 = model.fit_generator(train_gen, 
...
#CNN Metric Evaluation for B2
print("Preparing testing dataset..")
test_data_B2 = ImageDataGenerator(rescale=1./255)
test_gen_B2 = test_data_B2.flow_from_dataframe(dataframe=test,
                                            directory=srcdir,
                                            x_col=xcol,
                                            y_col=ycol,
                                            class_mode="categorical",
...
filenames_B2 = test_gen.filenames
nb_samples_B2 = len(filenames_B2)

prob_B2 = model.predict_generator(test_gen_B2,steps = nb_samples_B2)

pred_B2 = np.argmax(prob_B2, axis=1)
true_B2 = np.array(test_gen_B2.classes)

# # Plotting learning curve of accuracy based on CNN history
# num_epochs = 25
# epoch_nums = range(1,num_epochs+1)
# training_acc = cnn_training_B2.history["acc"]
# validation_acc = cnn_training_B2.history["val_acc"]
